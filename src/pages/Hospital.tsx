      ...
      <div className="relative z-10 pt-28 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            >
              <img 
                src="https://images.unsplash.com/photo-1516549655669-8443d5c5429c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" 
              ...
              <div className="p-6">
                ...
                <ul className="space-y-2 text-white/80">
                  <li className="flex items-center">
                    <span className="mr-2">📍</span> 123 Medical Center Drive, Health City
                  </li>
                  <li className="flex items-center">
          ...
          >
            <HospitalIcon className="w-16 h-16 text-medical mx-auto mb-4" />
